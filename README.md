...
# Data formats
The scripts use JSON objects to represent instances, models and confusion matrices. these objects can have additional keys associated with them beyond the ones specified below.
